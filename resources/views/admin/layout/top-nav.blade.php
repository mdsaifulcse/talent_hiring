                        ...
                        <ul class="show-notification row">
                            ...
                            <li class="col-sm-3">
                                ...
                                <div class="row m-b-20">
                                    <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="{{'admin/assets/images/mega-menu/01.jpg'}}" alt="Gallery-1">
                                    </div>
                                    <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="{{'admin/assets/images/mega-menu/02.jpg'}}" alt="Gallery-2">
                                    </div>
                                    <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="{{'admin/assets/images/mega-menu/03.jpg'}}" alt="Gallery-3">
                                    </div>
                                </div>
                                <div class="row m-b-20">
                                    <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="{{'admin/assets/images/mega-menu/04.jpg'}}" alt="Gallery-4">
                                    </div>
                                    <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="{{'admin/assets/images/mega-menu/05.jpg'}}" alt="Gallery-5">
                                    </div>
                                    <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="{{'admin/assets/images/mega-menu/06.jpg'}}" alt="Gallery-6">
                                    </div>
                                </div>
                ...
                <ul class="nav-right">
                    ...
                    <li class="header-notification">
                        ...
                        <ul class="show-notification">
                            ...
                            <li>
                                <div class="media">
                                    <img class="d-flex align-self-center" src="{{'admin/assets/images/user.png'}}" alt="Generic placeholder image">
                                    <div class="media-body">
